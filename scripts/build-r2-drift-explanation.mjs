...
function packetContextSections(payload) {
  ...
  for (const context of Object.values(payload.packetContext)) {
    lines.push(
      ...
      `- Vocabulary: ${context.vocabularyDoc ? `[\`${context.vocabularyDoc}\`](${docsHref(context.vocabularyDoc)})` : "n/a"}`,
...
export function buildMarkdown(payload) {
  ...
  const lines = [
    ...
    "",
    "_Generated by `node scripts/build-r2-drift-explanation.mjs` — do not hand-edit; regenerate with `npm run regen-review-artifacts`._",
    "",
