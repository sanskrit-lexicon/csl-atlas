...
## Codebase Intelligence for csl-atlas (Repowise)

Indexed by [Repowise](https://repowise.dev). Last indexed: 2026-08-01 (commit ad55f4e). Confidence: 100%.
...
### Architecture
**Files:** 855 | **Lines:** 619000
csl-atlas is a json codebase of 855 files. Execution starts at data/parse-rules/index.json, src/index.md. Start here when reading the codebase. Ranked by PageRank over the import graph: the files most of the codebase ultimately depends on.

### Key modules
- `scripts` — scripts
**Language:** javascript | **Files:** 107 | **Public symbols:** 449 / 1388
Covers the 107 source files in scripts
- `scripts/lib` — scripts/lib
**Language:** javascript | **Files:** 24 | **Public symbols:** 117 / 188
Covers the 24 source files in scripts/lib
- `scripts/L0` — scripts/L0
**Language:** python | **Files:** 20 | **Public symbols:** 198 / 204
Covers the 20 source files in scripts/L0
- `scripts/forensic` — scripts/forensic
**Language:** python | **Files:** 20 | **Public symbols:** 215 / 266
Covers the 20 source files in scripts/forensic
- `scripts/lexico` — scripts/lexico
**Language:** python | **Files:** 14 | **Public symbols:** 164 / 211
Covers the 14 source files in scripts/lexico
- `src` — src · src/lib
**Language:** javascript | **Files:** 6 | **Public symbols:** 42 / 67
Covers the 6 source files in 2 directories under src
- `scripts/obs` — scripts/obs · scripts/parse_rules
**Language:** python | **Files:** 5 | **Public symbols:** 64 / 64
Covers the 5 source files in 2…
- `root` — data/citations
**Language:** python | **Files:** 2 | **Public symbols:** 32 / 39
Covers the 2 source files in 2 directories under root

### Entry points
- `scripts/lib/dataset-meta.mjs`
- `scripts/lib/dict-parser.mjs`
- `scripts/lib/dict-scope.mjs`
- `scripts/lib/dict-normalize.mjs`
- `scripts/lib/dict-manifest.mjs`
- `scripts/lib/review-report.mjs`

### Files that need care (bug-fix history first, then churn — check `get_risk` before editing)
- `test/orchestrators.test.mjs` — 3 bug fixes, last fix 6 weeks ago; 29 commits/90d
- `test/lib.test.mjs` — 2 bug fixes, last fix 3 weeks ago; 21 commits/90d
- `scripts/build-h4-review-packet.mjs` — 2 bug fixes, last fix 6 weeks ago; 6 commits/90d
- `scripts/build-review-sheets.py` — 1 bug fix, last fix 12 days ago; 8 commits/90d
- `scripts/obs/citation_register_gaps.py` — 1 bug fix, last fix 2 weeks ago; 3 commits/90d

### Code health
Three co-equal signals: defect risk 9.65/10 avg, hotspot health 4.75/10 (stable), worst `src/lib/sanskrit-util.js` at 2.15/10 · maintainability 9.8/10 · performance risk 241 open static I/O-in-loop / N+1 findings. Detail: `get_health()`.

Critical files:
- `observablehq.config.js` — change entropy — impact −1.7
- `test/lib.test.mjs` — change entropy — impact −1.7
- `scripts/build-review-sheets.py` — change entropy — impact −1.7
- `test/orchestrators.test.mjs` — change entropy — impact −1.4
- `src/lib/sanskrit-util.js` — change entropy — impact −1.3
