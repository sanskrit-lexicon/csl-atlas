...
- Evidence: `src/data/block-by-type-matrix.json` and `src/data/palette-tokens.json`.
- Limitations: the heatmap reports recoverable MW structural blocks; it does not classify every semantic or editorial nuance.
