...
- Evidence: `src/data/article-type-counts.json`, `src/data/article-type-examples.json`, and MW source links.
- Limitations: article types are overlapping classifier memberships, not an exclusive partition of MW records.
