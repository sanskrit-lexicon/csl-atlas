...
- Evidence: `src/data/dicts/pairwise-overlap.json` generated from normalized dictionary headwords.
- Limitations: overlap measures shared headwords only; it does not prove direct copying, shared senses, or source dependence by itself.
