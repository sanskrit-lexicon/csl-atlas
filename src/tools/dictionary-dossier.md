...
- Evidence: `src/data/dicts/lemma-dossier.json`, normalized dictionary headwords, and source line links.
- Limitations: this static dossier only includes lemmas meeting the minimum dictionary coverage threshold; it is not a full search engine or corpus lookup.
