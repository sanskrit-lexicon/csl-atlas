...
- MW is the ONLY dict at L8 (full Dictionary→Book linking) — **superseded H2368, re-measured A10+A11 24-08-2026, A12 + A07 28-08-2026, A08 + A08 follow-up + H3695 29-08-2026, H3725 03-09-2026 (ticked 04-09-2026):** 44 dicts (mw, pwg, ap90, wil, cae, bor, fri, ieg, armh, krm, abch, pgn, snp, acsj, acph, bur, stc, vcp, ae, bhs, gra, ben, gst, inm, lan, mci, mw72, mwe, nybj, pe, shs, yat, bop, ap, ccs, lrv, md, sch, pw, pwkvn, pui, vei, acc, skd; all at 100% except ae 99.99%) are atlas-resolvable; print coordinates are near-universal; the sole remaining gap is `nmmb` (506 entries awaiting upstream scan images) — **99.97% overall**
