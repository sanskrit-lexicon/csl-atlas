...
**Where we are**: most dicts at L4-L6; 38 dicts (mw, pwg, ap90, wil, cae, bor, fri, ieg, armh, krm, abch, pgn, snp, acsj, acph, bur, stc, vcp, ae, bhs, gra, ben, gst, inm, lan, mci, mw72, mwe, nybj, pe, shs, yat, bop, ap, ccs, lrv, md, sch) at entry-level L8 under the atlas scan URL builder (H2368 census, A11 + A12 + A07 + A08 + A08 follow-up; 79.30% of all entries atlas-resolvable as of 29-08-2026).
