...
|---|---|---|---|---|---|---|---|
| H2 | Type 1 | Citation-supported senses survive better than uncited senses. | Supported in the R2 sense-alignment findings: cited ancestor senses survive at 70%, uncited senses at 54%. | [`R2_FINDINGS.md`](R2_FINDINGS.md), [`R2_REBUILD_CONTRACT.md`](R2_REBUILD_CONTRACT.md) | `csl-atlas` | Restore or rebuild the R2 generator package, then broaden beyond the 28-noun panel and three inheritance edges. | Sense-alignment methods paper; maker divergence worklist. |
...
| H1R | Type 1 | Sense granularity is a family/marking-style trait, not pure temporal inflation. | Replacement finding for H1: pure year trend is not supported; the current `/tools/r2-h1` page is a static snapshot of that result. | [`R2_FINDINGS.md`](R2_FINDINGS.md), [`R2_REBUILD_CONTRACT.md`](R2_REBUILD_CONTRACT.md), `/tools/r2-h1` | `csl-atlas` | Restore reproducible R2 artifacts or reimplement them against current `csl-orig`, then use family as a covariate. | Paper L / sense-evolution section. |
| H3R | Type 1 | Descendants copy or condense senses unless edge-specific evidence proves expansion. | Replacement finding for H3: net-addition is not supported on measured inheritance edges. | [`R2_FINDINGS.md`](R2_FINDINGS.md), [`R2_REBUILD_CONTRACT.md`](R2_REBUILD_CONTRACT.md) | `csl-atlas` | Test more directed edges after parser coverage improves. | Paper H; sense-drift dashboard. |
...
| H6 | Type 1 | Structural register predicts dictionary family. | Prototype-backed and charted: citation style plus grammar-marking separates Western-tagged, indigenous, index, and related traditions. | [`H6_STRUCTURAL_REGISTER_SCATTER.md`](H6_STRUCTURAL_REGISTER_SCATTER.md), `/tools/structural-register` | `csl-atlas` | Compare chart clusters to L0 genealogy and mark interpretation review status. | Macro profile dashboard; Paper M/H method note. |
...
| H4 | Type 1 | Semantic-field bias is measurable with Amarakosa-native fields. | Supported prototype: M8 maps AMAR vargas to dictionary headword coverage, and `/tools/semantic-fields` visualizes the result with caveats. | [`MICROSTRUCTURE_SEMANTIC_FIELDS.md`](MICROSTRUCTURE_SEMANTIC_FIELDS.md), `/tools/semantic-fields` | `csl-atlas` | Interpret field families and choose review samples without importing corpus categories. | Semantic-field dashboard; Paper L. |
...
| H5 | Type 2 | Ghost entries and rare anomalies identify both lineage and QA targets. | Scope now defined as a proof-first maker queue; no error claims before review. | [`H5_GHOST_ANOMALY_SCOPE.md`](H5_GHOST_ANOMALY_SCOPE.md), [`RESEARCH_LAYER_ROADMAP.md`](RESEARCH_LAYER_ROADMAP.md), [`LEXICOGRAPHY_ROADMAP.md`](LEXICOGRAPHY_ROADMAP.md) | `csl-atlas` | Create the first compact review report from F0/F2 samples and preserve review fields. | Maker QA worklist; forensic methods note. |
| H4-FIELD-FAMILY | Type 2 | AMAR field profiles differ by dictionary family, not only by gross coverage. | Interpretation package exists; review samples still need scholar adjudication. | [`MICROSTRUCTURE_SEMANTIC_FIELDS.md`](MICROSTRUCTURE_SEMANTIC_FIELDS.md), [`H4_SEMANTIC_FIELD_INTERPRETATION.md`](H4_SEMANTIC_FIELD_INTERPRETATION.md), `/tools/semantic-fields` | `csl-atlas` | Review SKD false lows, AP/AP90 deltas, VCP high coverage, and specialized baselines. | Semantic-field interpretation note. |
| XREF-HUBS | Type 2 | Cross-reference hub families preserve lineage and convention differences. | Hub-family review package exists; labels need scholar samples. | [`MICROSTRUCTURE_XREF_LINEAGE.md`](MICROSTRUCTURE_XREF_LINEAGE.md), [`MICROSTRUCTURE_XREF_HUB_REVIEW.md`](MICROSTRUCTURE_XREF_HUB_REVIEW.md) | `csl-atlas` | Compare PWG `Vgl.` hubs, MW `cf.` hubs, and Apte-family `cf.` hubs using review labels. | Cross-reference graph page; Paper H. |
