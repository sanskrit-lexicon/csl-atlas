...
| XREF-CORE | Type 1 | Cross-reference graphs preserve a shared core but not wholesale descent. | Supported, charted, and review-labeled: AP/AP90 is `edition-continuity`; MW/PWG is `lexical-shared-core` with prefix-convention hubs separated. | [`MICROSTRUCTURE_XREF_LINEAGE.md`](MICROSTRUCTURE_XREF_LINEAGE.md), [`MICROSTRUCTURE_XREF_HUB_REVIEW.md`](MICROSTRUCTURE_XREF_HUB_REVIEW.md), `data/lexico/xref_hub_review.json`, `/tools/xref-lineage` | `csl-atlas` | Source-check the MW/PWG 40-edge shared-core sample and a small PWG/MW prefix-hub sample before paper use. | Lineage graph dashboard; Paper H. |
...
| H4 | Type 1 | Semantic-field bias is measurable with Amarakosa-native fields. | Supported prototype and active review package: M8 maps AMAR vargas to dictionary headword coverage, `/tools/semantic-fields` visualizes the result, and the family-profile artifact groups 43 dictionaries into 5 evidence-bearing families. | [`MICROSTRUCTURE_SEMANTIC_FIELDS.md`](MICROSTRUCTURE_SEMANTIC_FIELDS.md), [`H4_SEMANTIC_FIELD_INTERPRETATION.md`](H4_SEMANTIC_FIELD_INTERPRETATION.md), [`H4_SEMANTIC_FIELD_REVIEW.md`](H4_SEMANTIC_FIELD_REVIEW.md), `data/lexico/semantic_field_family_profiles.json`, `/tools/semantic-fields` | `csl-atlas` | Start with SKD false-low checks, then review VCP high coverage, AP/AP90 deltas, specialized baselines, and index/reverse controls without importing corpus categories. | Semantic-field dashboard; Paper L. |
...
| H4-FIELD-FAMILY | Type 2 | AMAR field profiles differ by dictionary family, not only by gross coverage. | Family-profile artifact exists with top/low fields, distinctive clusters, and 12 high-spread contrast prompts; review packet is active but human adjudication is still pending. | [`MICROSTRUCTURE_SEMANTIC_FIELDS.md`](MICROSTRUCTURE_SEMANTIC_FIELDS.md), [`H4_SEMANTIC_FIELD_INTERPRETATION.md`](H4_SEMANTIC_FIELD_INTERPRETATION.md), [`H4_SEMANTIC_FIELD_REVIEW.md`](H4_SEMANTIC_FIELD_REVIEW.md), `data/lexico/semantic_field_family_profiles.json`, `/tools/semantic-fields` | `csl-atlas` | Apply the H4 starting labels to selected samples, beginning with SKD false-low rows. | Semantic-field interpretation note and review packet. |
| XREF-HUBS | Type 2 | Cross-reference hub families preserve lineage and convention differences. | Hub-review labels are documented: PWG/MW top targets are `prefix-convention`, AP/AP90/CAE are `lexical-target`, AE is `normalization-risk`, AP/AP90 is `edition-continuity`, and sparse rows are `too-sparse`; human source adjudication is still pending. | [`MICROSTRUCTURE_XREF_LINEAGE.md`](MICROSTRUCTURE_XREF_LINEAGE.md), [`MICROSTRUCTURE_XREF_HUB_REVIEW.md`](MICROSTRUCTURE_XREF_HUB_REVIEW.md), `data/lexico/xref_hub_review.json` | `csl-atlas` | Source-check the labeled samples, beginning with MW/PWG lexical shared-core edges. | Cross-reference graph page; Paper H. |
