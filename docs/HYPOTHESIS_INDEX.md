...
| H4-FIELD-FAMILY | Type 2 | AMAR field profiles differ by dictionary family, not only by gross coverage. | Family-profile artifact exists with top/low fields, distinctive clusters, and 12 high-spread contrast prompts; review samples still need scholar adjudication. | [`MICROSTRUCTURE_SEMANTIC_FIELDS.md`](MICROSTRUCTURE_SEMANTIC_FIELDS.md), [`H4_SEMANTIC_FIELD_INTERPRETATION.md`](H4_SEMANTIC_FIELD_INTERPRETATION.md), `data/lexico/semantic_field_family_profiles.json`, `/tools/semantic-fields` | `csl-atlas` | Review SKD false lows, AP/AP90 deltas, VCP high coverage, and specialized baselines. | Semantic-field interpretation note. |
