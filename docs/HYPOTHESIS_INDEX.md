...
| H6 | Type 1 | Structural register predicts dictionary family. | Prototype-backed, charted, and review-classed: citation style plus grammar-marking separates traditions, and `structural_register_h6_review.json` compares 13 L0 known edges against H6 space. | [`H6_STRUCTURAL_REGISTER_SCATTER.md`](H6_STRUCTURAL_REGISTER_SCATTER.md), [`H6_STRUCTURAL_REGISTER_REVIEW.md`](H6_STRUCTURAL_REGISTER_REVIEW.md), `data/lexico/structural_register_h6_review.json`, `/tools/structural-register` | `csl-atlas` | Use the H6 review packet to label positive controls, genealogy-structure tensions, structural convergences, intermediate cases, and family outliers. | Macro profile dashboard; Paper M/H method note. |
