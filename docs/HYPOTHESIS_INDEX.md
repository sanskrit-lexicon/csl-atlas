...
|---|---|---|---|---|---|---|---|
| H2 | Type 1 | Citation-supported senses survive better than uncited senses. | Supported in the R2 sense-alignment findings: cited ancestor senses survive at 70%, uncited senses at 54%. | [`R2_FINDINGS.md`](R2_FINDINGS.md) | `csl-atlas` | Restore or rebuild the R2 generator package, then broaden beyond the 28-noun panel and three inheritance edges. | Sense-alignment methods paper; maker divergence worklist. |
...
| H1R | Type 1 | Sense granularity is a family/marking-style trait, not pure temporal inflation. | Replacement finding for H1: pure year trend is not supported; the current `/tools/r2-h1` page is a static snapshot of that result. | [`R2_FINDINGS.md`](R2_FINDINGS.md), `/tools/r2-h1` | `csl-atlas` | Restore reproducible R2 artifacts or reimplement them against current `csl-orig`, then use family as a covariate. | Paper L / sense-evolution section. |
| H3R | Type 1 | Descendants copy or condense senses unless edge-specific evidence proves expansion. | Replacement finding for H3: net-addition is not supported on measured inheritance edges. | [`R2_FINDINGS.md`](R2_FINDINGS.md) | `csl-atlas` | Test more directed edges after parser coverage improves. | Paper H; sense-drift dashboard. |
...
| H5 | Type 2 | Ghost entries and rare anomalies identify both lineage and QA targets. | Method is clear from forensic and rarity signals; current scope still needs definition. | [`RESEARCH_LAYER_ROADMAP.md`](RESEARCH_LAYER_ROADMAP.md), [`LEXICOGRAPHY_ROADMAP.md`](LEXICOGRAPHY_ROADMAP.md) | `csl-atlas` | Define anomaly classes and run rarity-weighted pair matching. | Maker QA worklist; forensic methods note. |
| H4-FIELD-FAMILY | Type 2 | AMAR field profiles differ by dictionary family, not only by gross coverage. | The M8 data and chart exist; interpretation is not yet reviewed. | [`MICROSTRUCTURE_SEMANTIC_FIELDS.md`](MICROSTRUCTURE_SEMANTIC_FIELDS.md), `/tools/semantic-fields` | `csl-atlas` | Compare top-field profiles by family and sample SKD/VCP false lows. | Semantic-field interpretation note. |
| XREF-HUBS | Type 2 | Cross-reference hub families preserve lineage and convention differences. | M6 proves overlap and a positive control; hub-family interpretation remains open. | [`MICROSTRUCTURE_XREF_LINEAGE.md`](MICROSTRUCTURE_XREF_LINEAGE.md) | `csl-atlas` | Compare PWG `Vgl.` hubs, MW `cf.` hubs, and Apte-family `cf.` hubs. | Cross-reference graph page; Paper H. |
