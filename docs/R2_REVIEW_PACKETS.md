...
- Next use: record decisions in `src/data/review/r2-checkpoint-review.json`,
  using [`R2_CHECKPOINT_DECISIONS.md`](R2_CHECKPOINT_DECISIONS.md) and
...
The shared review-report overlay is `src/data/review/r2-checkpoint-review.json`,
generated by `npm run build-r2-checkpoint-review` from the checkpoint packet.
It keeps canonical empty human fields until review and preserves future human
