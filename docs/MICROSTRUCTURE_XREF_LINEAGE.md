...
- Evidence: `data/lexico/xref_edges.csv`, `data/lexico/xref_lineage.json`,
  `data/lexico/xref_shared_edges.csv`, `data/lexico/xref_hub_review.json`,
  `scripts/lexico/m3_xrefs.py`, and `scripts/lexico/m6_xref_lineage.py`. The
  public chart input is
  `src/data/dicts/xref-lineage.json`, generated by
  `scripts/build-xref-lineage.mjs`; the hub-review artifact is generated by
  `scripts/build-xref-hub-review.mjs`.
- Limitations: graph overlap is a floor and is not proof of direct copying by
  itself.
