...
- **Output.** 1,496,157 entries → 410,259 distinct lemmas (≈3.65 : 1); the redundancy is *structured* — general dictionaries mutually derivative, specialised and indigenous lexica novel.
