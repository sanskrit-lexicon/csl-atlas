...
**Status:** working draft (2026-06-17; data-verification + references pass 2026-07-02; hostile referee pass + apparatus fixes 2026-07-03, Fable 5 `claude-fable-5` — see [A01_review_fable5.md](https://github.com/sanskrit-lexicon/csl-atlas/blob/main/docs/articles/A01_review_fable5.md)). P1 — the foundational methods paper of the atlas series; the companions each instantiate one or more of its metrics. Author decisions (byline, venue) are flagged inline.
