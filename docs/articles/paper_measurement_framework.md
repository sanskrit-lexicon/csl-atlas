...
**Status:** submit-ready draft pending author sign-off (2026-06-17 draft; data-verification + references pass 2026-07-02; hostile referee pass + apparatus fixes 2026-07-03; author-voice pass 2026-07-08, Fable 5 `claude-fable-5` — see [A01_review_fable5.md](https://github.com/sanskrit-lexicon/csl-atlas/blob/main/docs/articles/A01_review_fable5.md) and [SIGNOFF_A01_author_pass.md](https://github.com/sanskrit-lexicon/csl-atlas/blob/main/docs/articles/SIGNOFF_A01_author_pass.md)). P1 — the foundational methods paper of the atlas series; the companions each instantiate one or more of its metrics.
...
- **Output.** 1,496,157 entries → 410,259 distinct lemmas (≈3.65 : 1), per the committed artifact [`data/obs/headword_collapse.json`](https://github.com/sanskrit-lexicon/csl-atlas/blob/main/data/obs/headword_collapse.json); the redundancy is *structured* — general dictionaries mutually derivative, specialised and indigenous lexica novel.
