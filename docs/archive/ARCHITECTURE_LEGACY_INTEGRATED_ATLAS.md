...
Scope note (2026-06-03): `docs/BOUNDARY_RULES.md` supersedes this file where
they conflict. `csl-atlas` is now the dictionary-evidence path only. Corpus,
grammar, GitHub/org observability, and general standards/export work must move
or stay outside this repo unless they directly start from dictionary evidence.
Corpus sections below are historical planning notes, not active atlas direction.
...
Detailed plan: moved out of this repo. DCS migration copies are preserved in
