...
**First action in a new chat:** read `DECISIONS_NEEDED.md` and resurface the open items to the maintainer. Two parallel streams are active:

**A · Engineering / data-quality** — journal: [`csl-corrections/.ai_state.md`](https://github.com/sanskrit-lexicon/csl-corrections/blob/main/.ai_state.md).
- Done: markup fixes for 10 csl-orig dicts; issue taxonomy on 6 dict repos (BOR/BUR/INM/KRM/BOP/MW72); full README+CLAUDE+citation/community docs for those 6; org-wide `CONTRIBUTOR_STATS.md`; ecosystem `ROADMAP.md` + 7 tracked issues; **quick wins Q1–Q6 shipped** — hw.py BOM `utf-8-sig` fix (csl-pywork#50), `.gitattributes`×7, csl-orig encoding+`<L>/<LEND>` CI guard, contributor-identity map, Mermaid validator, AI-contribution policy, `clone_org.py`.
...
|---|---|---|
| 1 | `SESSION_HANDOFF.md` | THIS doc — orientation |
| 2 | `OBSERVATORY_DESIGN.md` | Architecture: Observable Framework, GitHub Actions, snapshot strategy, KPI catalog |
| 3 | `OBSERVATORY_ROADMAP.md` | Phases A-H for the measurement framework |
...
| 9 | `PAPER_1_OUTLINE.md` | Paragraph-by-paragraph outline of Paper 1 |
...
- `data/etymology_marker_preliminary.csv` — WIL/MW/AP etymology markers
